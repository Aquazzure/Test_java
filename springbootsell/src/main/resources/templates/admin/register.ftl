...
<body>
<div class="box">
    <form name="form2" id="regUser" accept-charset="utf-8"  action="/seller/admin/load_register" method="post">
        <ul class="reg_form" id="reg-ul">
            <div id="userCue" class="cue">快速注册请注意格式</div>
            <li>
                <label for="adminName"  class="input-tips2">用户名：</label>
                <div class="inputOuter2">
                    <input type="text" id="adminName" name="adminName" maxlength="16" class="inputstyle2"/>
                </div>
            </li>
            <li>
